...
var yargs = require('yargs')
  ...
  .describe('account', 'scrape one or more named accounts (default: scrape all accounts)')
  .describe('start', 'the state date (inclusive) for transactions in YYYY-MM-DD')
  .describe('end', 'the end date (inclusive) for transactions in YYYY-MM-DD')
